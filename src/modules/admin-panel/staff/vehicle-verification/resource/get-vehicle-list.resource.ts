...
class InspectionImagesVehicleListResource extends BaseResource<any> {
    toJSON() {
        const photos = this.data;
...
export class GetVehicleListingResource extends BaseResource<any> {
    toJSON() {
        ...
        return {
            ...
            // inspectionImages: InspectionImagesVehicleListResource.collection(inspectionImages || []),
        };
    }
}
