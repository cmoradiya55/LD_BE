...
export class AdminPincodeCitySuggestionResource extends BaseResource<Pincode> {
    ...
    toJSON() {
        return {
            formatted: CommonHelper.text(`${this.data.pincode}, ${this.data.area_name}`),
            ...
            state_name: CommonHelper.text(this.toTitle(this.data.city.state_name)),
        };
    }
}
